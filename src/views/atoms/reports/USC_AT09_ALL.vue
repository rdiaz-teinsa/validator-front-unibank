        ...
        return {
            ...
            columns: [
                ...
                },
                {
                    ...
                    children: [
                        {
                            headerName: "Promedio Días",
                            field: "AT09_PROMEDIO_DIAS",
                            headerClass: 'headerBlue',
                            width: '100px'
                        },
                        {
                            headerName: "Tasa Promedio",
                            field: "AT09_TASA_PROMEDIO",
                            headerClass: 'headerBlue',
                            width: '100px'
                        },
                        {
                            headerName: "Tasa Máxima",
                            field: "AT09_TASA_MAXIMA",
                            sortable: false,
                            headerClass: 'headerBlue',
                            width: '80px'
                        },
                        {
                          ...
                          headerClass: 'headerBlue',
                            sortable: false,
                            valueFormatter: params => this.currencyFormatFn(params.data.AT09_MONTO),
                ...
                },
                {
                    ...
                    children: [
                        {
                            headerName: "Promedio Días",
                            field: "AT_PROMEDIO_DIAS",
                            headerClass: 'headerBlue',
                            width: '100px'
                        },
                        {
                            headerName: "Tasa Promedio",
                            field: "AT_TASA_PROMEDIO",
                            headerClass: 'headerBlue',
                            width: '100px'
                        },
                        {
                            headerName: "Tasa Máxima",
                            field: "AT_TASA_MAXIMA",
                            sortable: false,
                            headerClass: 'headerBlue',
                            width: '80px'
                        },
                        {
                            ...
                            field: "AT_MONTO",
                          headerClass: 'headerBlue',
                            valueFormatter: params => this.currencyFormatFn(params.data.AT_MONTO),
                          cellClass: 'numberType',
                        },
                    ]
                },
                {
                    ...
                    children: [
                        {
                            headerName: "Promedio Días",
                            field: "DIF_PROMEDIO_DIAS",
                            headerClass: 'headerBlue',
                            width: '100px'
                        },
                        {
                            headerName: "Tasa Promedio",
                            field: "DIF_TASA_PROMEDIO",
                            headerClass: 'headerBlue',
                            width: '100px'
                        },
                        {
                            headerName: "Tasa Máxima",
                            field: "DIF_TASA_MAXIMA",
                            sortable: false,
                            headerClass: 'headerBlue',
                            width: '80px'
                        },
        ...
        async generateReport() {
            try {
                ...
                const res = await this.$http.post(
                    environment.uri + "/reportes/validator/code/761/",
                    {
