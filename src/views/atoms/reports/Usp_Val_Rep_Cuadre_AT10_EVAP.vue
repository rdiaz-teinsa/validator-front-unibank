                    ...
                    children: [
                        {
                          ...
                          cellClass: 'numberType',
                            valueFormatter: params => this.currencyFormatFn(params.data.TOTAL_AT10),
                        },
                        {
                            headerName: "EVAP",
                            field: "TOTAL_EVAP",
                          headerClass: 'headerBlue',
                          cellClass: 'numberType',
                            valueFormatter: params => this.currencyFormatFn(params.data.TOTAL_EVAP),
                        },
                        {
        ...
        async generateReport() {
            try {
                ...
                const res = await this.$http.post(
                    environment.uri + "/reportes/validator/code/245/",
                    {
