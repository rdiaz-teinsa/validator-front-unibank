            ...
            columns: [
                {
                    ...
                    children: [
                        ...
                        {
                            headerName: "Descripción Depósito",
                            field: "DESCRIPCION",
                            headerClass: 'headerBlue',
                            sortable: false,
                        },
                        ...
                        {
                            headerName: "Descripción Cliente",
                            field: "GRUPO",
                            headerClass: 'headerBlue',
                            sortable: false,
                            width: '110px'
                    ...
                    children: [
                        {
                          ...
                          cellClass: 'numberType',
                            valueFormatter: params => this.currencyFormatFn(params.data.MONTO_AT02),
                            type: 'number',
                            width: '100px'
                        },
                        {
        ...
        async generateReport() {
            try {
                ...
                const res = await this.$http.post(
                    environment.uri + "/reportes/validator/code/764/",
                    {
