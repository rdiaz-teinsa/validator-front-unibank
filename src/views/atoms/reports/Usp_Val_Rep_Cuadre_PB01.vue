...
export default {
    ...
    data() {
        return {
            ...
            cutOffDate: '2018-03-31',
            columns: [
                {
                    headerName: "Comparación x Cuenta",
                    field: "COMPARACION_X_CUENTA",
                    headerClass: 'headerBlue',
                },
                {
                    headerName: "Cuenta Base",
                    field: "CUENTA_1_001",
                    headerClass: 'headerBlue',
                },
                {
                    headerName: "Cuenta Comparada",
                    field: "CUENTA_COMPARADA",
                    headerClass: 'headerBlue',
                },
                {
                    headerName: "Cant. Depósitos",
                    field: "CANTIDADDEPOSITO",
                    headerClass: 'headerBlue',
                    cellClass: 'numberType',
                },
                {
                    headerName: "Total Depósitos",
                    field: "TOTALDEPOSITO",
                    headerClass: 'headerBlue',
                    cellClass: 'numberType',
                    valueFormatter: params => this.currencyFormatFn(params.data.TOTALDEPOSITO),
                },
                {
                    headerName: "Cant. Retiros",
                    field: "CANTIDADRETIRO",
                    headerClass: 'headerBlue',
                    cellClass: 'numberType',
                },
                {
                    headerName: "Total Retiros",
                    field: "TOTALRETIRO",
                    headerClass: 'headerBlue',
                    cellClass: 'numberType',
                    valueFormatter: params => this.currencyFormatFn(params.data.TOTALRETIRO),
                },
                {
                    headerName: "Cant. Depósitos (Comparada)",
                    field: "CANTIDADDEPOSITO_COMPARADO",
                    headerClass: 'headerBlue',
                    cellClass: 'numberType',
                },
                {
                    headerName: "Total Depósitos (Comparada)",
                    field: "TOTALDEPOSITO_COMPARADO",
                    headerClass: 'headerBlue',
                    cellClass: 'numberType',
                    valueFormatter: params => this.currencyFormatFn(params.data.TOTALDEPOSITO_COMPARADO),
                },
                {
                    headerName: "Cant. Retiros (Comparada)",
                    field: "CANTIDADRETIRO_COMPARADO",
                    headerClass: 'headerBlue',
                    cellClass: 'numberType',
                },
                {
                    headerName: "Total Retiros (Comparada)",
                    field: "TOTALRETIRO_COMPARADO",
                    headerClass: 'headerBlue',
                    cellClass: 'numberType',
                    valueFormatter: params => this.currencyFormatFn(params.data.TOTALRETIRO_COMPARADO),
                },
                {
                    headerName: "Dif. Cant. Depósitos",
                    field: "DIFERENCIA_CANTIDADDEPOSITO",
                    headerClass: 'headerBlue',
                    cellClass: 'numberType',
                },
                {
                    headerName: "Dif. Total Depósitos",
                    field: "DIFERENCIA_TOTALDEPOSITO",
                    headerClass: 'headerBlue',
                    cellClass: 'numberType',
                    valueFormatter: params => this.currencyFormatFn(params.data.DIFERENCIA_TOTALDEPOSITO),
                },
                {
                    headerName: "Dif. Cant. Retiros",
                    field: "DIFERENCIA_CANTIDADRETIRO",
                    headerClass: 'headerBlue',
                    cellClass: 'numberType',
                },
                {
                    headerName: "Dif. Total Retiros",
                    field: "DIFERENCIA_TOTALRETIRO",
                    headerClass: 'headerBlue',
                    cellClass: 'numberType',
                    valueFormatter: params => this.currencyFormatFn(params.data.DIFERENCIA_TOTALRETIRO),
                },
            ],
            pageLength: 50,
            searchTerm: "",
        ...
        async generateReport() {
            try {
                ...
                const res = await this.$http.post(
                    environment.uri + "/reportes/validator/code/1002/",
                    {
