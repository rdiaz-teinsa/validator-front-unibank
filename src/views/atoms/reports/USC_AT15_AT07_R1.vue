            ...
            columns: [
                {
                    ...
                    children: [
                        {
                            headerName: "Titulo",
                            field: "TIPO_TITULO_SB13",
                          headerClass: 'headerBlue',
                        },
                        {
                            headerName: "Categoría",
                            field: "CATEGORIA_SB18",
                          headerClass: 'headerBlue',
                        ...
                        {
                            headerName: "Serie Instrumento",
                            field: "SERIE_INSTRUMENTO",
                          headerClass: 'headerBlue',
                          cellClass: 'stringType',
                          cellClassRules: 'stringType',
                        },
                        {
                            headerName: "Calificación Riesgo",
                            field: "CALIF_RIESGO_SB25",
                          headerClass: 'headerBlue',
                          cellClass: 'stringType',
                        },
                        {
                        ...
                        {
                            headerName: "Nombre Ente",
                            field: "NOMBRE_ENTE_AT07",
                          headerClass: 'headerBlue',
                        },
                        {
                            headerName: "Días Remanentes",
                            field: "DIAS_REMANETES",
                          headerClass: 'headerBlue',
                        },
                        {
                          ...
                          cellClass: 'numberType',
                            valueFormatter: params => this.currencyFormatFn(params.data.VALOR_MERCADO),
        ...
        async generateReport() {
            try {
                ...
                const res = await this.$http.post(
                    environment.uri + "/reportes/validator/code/280/",
                    {
