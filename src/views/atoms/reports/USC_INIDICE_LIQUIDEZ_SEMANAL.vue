  ...
  data() {
    return {
      ...
      columns: [
        ...
        {
          headerName: "Descripción Rubro",
          field: "DESCRIPCION_RUBRO",
          sortable: false,
          headerClass: 'headerBlue',
          width: '180px'
        },
        ...
        },
        {
          ...
          headerClass: 'headerBlue',
          cellClass: 'numberType',
          valueFormatter: params => this.currencyFormatFn(params.data.VARIACION),
        },
        {
          headerName: "Fecha Anterior",
          field: "FECHA_ACTUAL",
          headerClass: 'headerBlue',
          cellClass: 'dateType',
          valueFormatter: params => this.dateFormatFn(params.data.FECHA_ACTUAL),
        },
        {
          headerName: "Fecha Actual",
          field: "FECHA_ANTERIOR",
          headerClass: 'headerBlue',
          cellClass: 'dateType',
          valueFormatter: params => this.dateFormatFn(params.data.FECHA_ANTERIOR),
        },
      ],
      searchTerm: "",
      loading: false,
    ...
    async generateReport() {
      try {
        ...
        const res = await this.$http.post(
            environment.uri + "/reportes/validator/code/330/",
            {
