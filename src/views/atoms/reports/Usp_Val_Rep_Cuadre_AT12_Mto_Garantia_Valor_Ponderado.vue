...
export default {
    ...
    data() {
        return {
            ...
            columns2: [
              {
                headerName: 'Átomo Garantía AT12',
                headerClass: 'headerWhite headerCenter',
                children: [
                  {
                    headerName: "Indentificación Garantía",
                  ...
                  },
                  {
                    ...
                    valueFormatter: params => this.currencyFormatFn(params.data.MONTO_GARANTIA),
        ...
        async generateReport() {
            try {
                ...
                const res = await this.$http.post(
                    environment.uri + "/reportes/validator/code/270/",
                    {
