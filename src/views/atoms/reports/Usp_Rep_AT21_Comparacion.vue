<template>
    <b-card-code :title="this.$route.query.report">
        <b-row>
            ...
            <b-col md="4">
                <b-button :disabled="!this.$store.state.app.fechaCorte" variant="primary" @click="generateReport">Generar Reporte</b-button>
            </b-col>
        </b-row>
        ...
        async generateReport() {
            try {
                ...
                const res = await this.$http.post(
                    environment.uri + "/reportes/validator/code/763/",
                    {
